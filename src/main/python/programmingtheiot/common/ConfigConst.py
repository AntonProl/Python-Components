...
class ConfigConst:
    ...
    DEFAULT_CONFIG_FILE_NAME = '/home/antonprol/Escritorio/practicas_pic/Python-Components/config/PiotConfig.props'
    DEFAULT_CRED_FILE_NAME = '/home/antonprol/Escritorio/practicas_pic/Python-Components/config/PiotConfig.props'
